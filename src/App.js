...
// eslint-disable-next-line
import Actividad2A from './components/Actividad2A';
// eslint-disable-next-line
import Actividad2B from './components/Actividad2B'
import Actividad2C from './components/Actividad2C'
import Actividad2D from './components/Actividad2D'
...
const App = () => {
  return(
    <>
      <Gstyle/>
      <Fondo degradado={Ilex.degradado('-60deg',Ilex.color_rosa_radios,Ilex.color_azul_reading,Ilex.color_violeta_speaking)}>
        <HashRouter>
          ...
          <Route path='/actividad2b' component={Actividad2B} />
          <Route path='/actividad2c' component={Actividad2C} />
          <Route path='/actividad2d' component={Actividad2D} />
        </HashRouter>
