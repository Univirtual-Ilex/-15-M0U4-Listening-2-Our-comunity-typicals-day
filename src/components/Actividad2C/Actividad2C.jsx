    ...
    return (
        <Container bgImage='./src/bg_actividad1.png' h={38} w={80} {...props}>
            ...
            <IRow pt={2} w={85} justify={'center'} className="columns" align={'center'} className="questions">
                <ICol w={28} >
                    <IRow>
                        <div className="title">UTP'S SECRETARY</div>
                        <Area className={"persona4"} title={Data[3].name}/>
            ...
            <Modal visible={modalFlag} ok={ok} err={err} w={25} repeatUrl={'#/actividad2c'} nxtUrl={'#/actividad2d'} />
        </Container>
